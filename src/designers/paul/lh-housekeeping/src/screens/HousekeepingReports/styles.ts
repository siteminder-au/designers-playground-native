...
const styles = StyleSheet.create({
  ...
  // Room Notes bottom sheet (Figma node 742:56218) — single add/edit field,
  // no threaded history or category picker.
  notesSheetHeader: {
    flexDirection: 'row' as const, alignItems: 'flex-start' as const, justifyContent: 'space-between' as const,
    padding: 16,
  },
  notesSheetHeaderTitle:    { fontSize: 16, lineHeight: 21, fontWeight: '700' as const, color: '#333333' },
  notesSheetHeaderSubtitle: { fontSize: 14, lineHeight: 18, fontWeight: '600' as const, color: '#6d7272', marginTop: 4 },
  notesSheetLabel: { fontSize: 12, lineHeight: 16, fontWeight: '700' as const, color: '#333333', marginBottom: 4 },
  notesSheetInput: {
    borderWidth: 1, borderColor: '#ccd1d1', borderRadius: 6,
    paddingHorizontal: 16, paddingVertical: 10,
    fontSize: 16, lineHeight: 21, color: '#333333',
    minHeight: 90, textAlignVertical: 'top' as const,
  },
  notesCharCount: { fontSize: 12, lineHeight: 16, color: '#6d7272', textAlign: 'right' as const, marginTop: 4 },
