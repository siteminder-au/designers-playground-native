...
type FlagsState = typeof PM_FLAGS;

export function PaymentMethodDemoFlagsSheet({
  visible,
  onClose,
  sheetAnim,
  translateY,
      ...
      <Animated.View style={[styles.overlay, { opacity: sheetAnim }]}>
        ...
        <Animated.View style={[styles.sheet, { transform: [{ translateY }] }]}>
          ...
          <View style={styles.header}>
            ...
            <TouchableOpacity onPress={() => setFlags({ ...PM_FLAGS })}>
          ...
          <ScrollView contentContainerStyle={{ paddingBottom: insetsBottom + 16 }}>
            <View style={styles.variantRow}>
              ...
              <View style={styles.optionList}>
                {([
                  { value: 'row', label: 'Text row', hint: 'Icon + label + arrow, with body copy below' },
                  ...
                  { value: 'badge', label: 'Small badge', hint: 'Pill only, lowest-key discovery' },
